...
const HamburgerButton = forwardRef<HTMLButtonElement, hamburgerProps>(({ isOpen, toggleSidebar, setSelectedProject }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`${genericHamburgerLine} ${
          isOpen
            ? "opacity-50 -translate-y-3 -rotate-45 group-hover:opacity-100"
            : "opacity-50 group-hover:opacity-100"
        }`}
      />
    </button>
